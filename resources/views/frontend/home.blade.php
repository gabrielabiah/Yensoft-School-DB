            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s"
                        ...
                        <div class="team-image">
                            <img src="{{ asset('frontend/assets/images/team-1.png') }}" alt="Team">
                            <div class="social">
                                <ul>
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s"
                        data-wow-delay="0.5s">
                        <div class="team-image">
                            <img src="{{ asset('frontend/assets/images/team-2.png') }}" alt="Team">
                            <div class="social">
                                <ul>
                                    <li><a href="#"><i class="lni-facebook-filled"></i></a></li>
                                    <li><a href="#"><i class="lni-twitter-filled"></i></a></li>
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s"
                        data-wow-delay="0.8s">
                        <div class="team-image">
                            <img src="{{ asset('frontend/assets/images/team-3.png') }}" alt="Team">
                            <div class="social">
                                <ul>
                                    <li><a href="#"><i class="lni-facebook-filled"></i></a></li>
                                    <li><a href="#"><i class="lni-twitter-filled"></i></a></li>
                ...
                <div class="col-lg-4">
                    <div class="single-testimonial">
                        ...
                        <div class="testimonial-text">
                            <p class="text">Lorem ipsum dolor sit amet,consetetur sadipscing elitr, seddiam nonu
                                eirmod tempor invidunt labore.Lorem ipsum dolor sit amet,consetetur sadipscing
                                elitr, seddiam nonu.</p>
                        </div>
                        <div class="testimonial-author d-flex align-items-center">
                            <div class="author-image">
                                <img class="shape" src="{{ asset('frontend/assets/images/textimonial-shape.svg') }}"
                                    alt="shape">
                                <img class="author" src="{{ asset('frontend/assets/images/author-1.png') }}"
                                    alt="author">
                            </div>
                    ...
                    <div class="single-testimonial">
                        ...
                        <div class="testimonial-author d-flex align-items-center">
                            <div class="author-image">
                                <img class="shape" src="{{ asset('frontend/assets/images/textimonial-shape.svg') }}"
                                    alt="shape">
                                <img class="author" src="{{ asset('frontend/assets/images/author-2.png') }}"
                                    alt="author">
                            </div>
                            <div class="author-content media-body">
                    ...
                    <div class="single-testimonial">
                        ...
                        <div class="testimonial-author d-flex align-items-center">
                            <div class="author-image">
                                <img class="shape" src="{{ asset('frontend/assets/images/textimonial-shape.svg') }}"
                                    alt="shape">
                                <img class="author" src="{{ asset('frontend/assets/images/author-3.png') }}"
                                    alt="author">
                            </div>
                            <div class="author-content media-body">
                ...
                <div class="col-lg-4 col-md-7">
                    <div class="single-blog mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        ...
                        <div class="blog-content">
                            ...
                            <p class="text">Lorem ipsuamet conset sadips cing elitr seddiam nonu eirmod tempor
                                invidunt labore.</p>
                            <a class="more" href="#">Learn More <i class="lni-chevron-right"></i></a>
                        </div>
                    </div> <!-- single blog -->
