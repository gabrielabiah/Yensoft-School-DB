                ...
                <li>
                    ...
                    <div class="desc">
                        ...
                        <ul class="list-unstyled team-info margin-0 p-t-5">                                            
                            <li><img src="{{asset('ericsson/images/xs/avatar1.jpg')}}" alt="Avatar"></li>
                            <li><img src="{{asset('ericsson/images/xs/avatar2.jpg')}}" alt="Avatar"></li>
                            <li><img src="{{asset('ericsson/images/xs/avatar3.jpg')}}" alt="Avatar"></li>
                            <li><img src="{{asset('ericsson/images/xs/avatar4.jpg')}}" alt="Avatar"></li>                                            
                        </ul>
                    </div>
                </li>
                <li>
