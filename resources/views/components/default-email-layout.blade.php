            ...
            <tr>
                <td>
                            ...
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-repeat: no-repeat; background-position: center top; color: #000000; background-image: url('images/blue-glow_3.jpg'); width: 600px;"
                                        width="600">
                                        <tbody>
                                            <tr>
                                                        ...
                                                        <tr>
                                                            <td style="width:100%;padding-right:0px;padding-left:0px;">
                                                                <div align="center" style="line-height:10px"><img
                                                                        ...
                                                                        src="{{ asset('emails/default/images/top-rounded.png') }}"
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        class="row-content stack" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-position: center top; color: #000000; background-color: #ffffff; width: 600px;"
                                        width="600">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td
                                                                ...
                                                                <div align="center" style="line-height:10px"><img
                                                                        alt="book shelf"
                                                                        src="{{ asset('emails/default/images/shelf.jpg') }}"
                                                            ...
                                                            <td
                                                                ...
                                                                <div align="center">
                                                                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://www.example.com" style="height:52px;width:199px;v-text-anchor:middle;" arcsize="8%" stroke="false" fillcolor="#ff7d14"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px"><![endif]--><a
                                                                        href="{{ $url }}"
                                                                        style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#ff7d14;border-radius:4px;width:auto;border-top:1px solid #ff7d14;font-weight:undefined;border-right:1px solid #ff7d14;border-bottom:1px solid #ff7d14;border-left:1px solid #ff7d14;padding-top:10px;padding-bottom:10px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"
                                                                        target="_blank"><span
                                                                            style="padding-left:60px;padding-right:60px;font-size:16px;display:inline-block;letter-spacing:normal;"><span
                                                                                style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;">{{ $button_title }}</span></span></a>
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-4"
                        role="presentation"
                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ff7d14;" width="100%">
                        <tbody>
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            {{-- <tr>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td style="width:100%;padding-right:0px;padding-left:0px;">
                                                                <div align="center" style="line-height:10px"><img
                                                                        alt="audio book"
                                                                        src="{{ asset('emails/default/images/book-app.png') }}"
                                                                        style="display: block; height: auto; border: 0; width: 195px; max-width: 100%;"
                                                                        title="audio book" width="195" /></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td class="column column-2"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td
                                                                style="padding-bottom:80px;padding-left:40px;padding-right:40px;padding-top:40px;width:100%;">
                                                                <div align="center" style="line-height:10px"><img
                                                                        alt="book icon"
                                                                        src="{{ asset('emails/default/images/book-unlimited.gif') }}"
                                                                        style="display: block; height: auto; border: 0; width: 110px; max-width: 100%;"
                                                                        title="book icon" width="110" /></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td
                                                                style="padding-bottom:5px;padding-top:25px;text-align:center;width:100%;">
                                                                <h2
                                                                    style="margin: 0; color: #555555; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 24px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0;">
                                                                    <strong>Your books, online and off</strong>
                                                                </h2>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                            ...
                                                            <td
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 32.4px;">
                                                                            <span style="font-size:18px;">You now
                                                                                get
                                                                                unlimited downloads to take all your
                                                                                books with you on up to 5
                                                                                devices.</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 32.4px;">
                                                                            <span style="font-size:18px;">Follow
                                                                                us</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding:0 7px 0 7px;"><a
                                                                                ...
                                                                                target="_blank"><img alt="Facebook"
                                                                                    height="32"
                                                                                    src="{{ asset('emails/default/images/facebook2x.png') }}"
                                                                        ...
                                                                        <td style="padding:0 7px 0 7px;"><a
                                                                                ...
                                                                                target="_blank"><img alt="Twitter"
                                                                                    height="32"
                                                                                    src="{{ asset('emails/default/images/twitter2x.png') }}"
                                                                                    style="display: block; height: auto; border: 0;"
                                                                        ...
                                                                        <td style="padding:0 7px 0 7px;"><a
                                                                                ...
                                                                                target="_blank"><img alt="Instagram"
                                                                                    height="32"
                                                                                    src="{{ asset('emails/default/images/instagram2x.png') }}"
                                                                                    style="display: block; height: auto; border: 0;"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td style="width:100%;padding-right:0px;padding-left:0px;">
                                                                <div align="center" style="line-height:10px"><img
                                                                        class="fullMobileWidth big"
                                                                        src="{{ asset('emails/default/images/bottom-rounded.png') }}"
                                                                        style="display: block; height: auto; border: 0; width: 600px; max-width: 100%;"
                                                                        width="600" /></div>
                                                            </td>
                                                        </tr>
                                                                    ...
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:12px;">©
                                                                                {{ date('Y') }}
                                                                                YensoftGH | Bolgatanga, Upper East
                                                                                Region,
                                                                                Ghana </span>
                                                                        </p>
                                                                    </div>
                                                            ...
                                                            <td
                                                                ...
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        ...
                                                                        <p
                                                                            style="margin: 0; font-size: 14px; text-align: center;">
                                                                            {{-- <span style="font-size:12px;">If you
                                                                                prefer
                                                                                not to receive marketing emails form
                                                                                this list, <a
                                                                                    href="http://www.example.com"
                                                                                    rel="noopener"
                                                                                    style="text-decoration: underline; color: #262b30;"
                                                                            ...
                                                                            <table cellpadding="0" cellspacing="0"
                                                                                ...
                                                                                <tr>
                                                                                    {{-- <td
                                                                                        ...
                                                                                        <a href="https://www.designedwithbee.com/"
                                                                                            ...
                                                                                            target="_blank"><img
                                                                                                ...
                                                                                                class="icon"
                                                                                                height="32"
                                                                                                src="{{ asset('emails/default/images/bee.png') }}"
                                                                                    ...
                                                                                    <td
                                                                                        ...
                                                                                        <a href="https://yensoftgh.com/"
                                                                                            style="color: #9d9d9d; text-decoration: none;"
                                                                                            target="_blank">YensoftGH
