            ...
            <div class="card-body form-horizontal">
                ...
                <form action="{{ url('user/onboarding') }}" method="post">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">Name of School <span
                    ...
                    <fieldset disabled>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 col-form-label">Email address <span
                                            class="text-danger">*</span></label>
                                    <div class="col-md-7">
                                        <input type="text" name="user_emaild" class="form-control"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-7">
                            <input type="text" name="fname" class="form-control"
                                value="{{ getFirstName(Auth::user()->name) }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-7">
                            <input type="text" name="lname" class="form-control"
                                value="{{ getLastName(Auth::user()->name) }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-7">
                            <select name="gender" class="form-control custom-select">
                                ...
                                @if (getGender(Auth::user()->id) != '')
                                    <option value="{{ getGender(Auth::user()->id) }}" selected>
                                        {{ getGender(Auth::user()->id) }}</option>
                                @endif
